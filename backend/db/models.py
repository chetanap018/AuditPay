...
from sqlalchemy import Boolean, DateTime, Float, ForeignKey, Integer, String, Text, Index, UniqueConstraint  # pyright: ignore[reportMissingImports]
...
class SavedProduct(Base):
    ...
    __table_args__ = (
        UniqueConstraint("product_id", "session_id", name="uq_saved_product_session"),
    )
